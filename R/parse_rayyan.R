## Using this function from rayyanR to test the package set up and we will build on this to help develop agreement scores and other functions
...
#' @details function (beta) to remove any old inclusion labels from abstract screening (found in the labels or parsed as html paragraphs)
